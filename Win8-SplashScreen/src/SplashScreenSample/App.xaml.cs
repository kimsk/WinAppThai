...
namespace SplashScreenSample
{
    ...
    sealed partial class App : Application
    {
        ...
        {
            // เราเริ่มโดยการเช็คว่าแอพเรากำลังรันอยู่หรือเปล่า
            // First we want to check to see if the application was already running.
            if (args.PreviousExecutionState != ApplicationExecutionState.Running)
            {
                // ถ้าไม่ได้รันอยู่เราจะเช็คว่าครั้งสุดท้ายที่แอพเรารันได้ถูก terminated หรือเปล่า
                // เราจะผ่านค่านี้ไปให้ Splash page
                // If it wasn't, then we want to check ot see if it was terminated the last time it was run.
                // which we will pass on to our Splash page.
                bool loadState = (args.PreviousExecutionState == ApplicationExecutionState.Terminated);

                // สร้างเพจ Splash และผ่าน SplashScreen object กับ loadState ทาง constructor
                ...
                // เซ็ต content ของแอพไปที่เพจ Splash
